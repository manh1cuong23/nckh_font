        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="Home" link={Routes.Presentation.path} />
              <NavItem title="Dashboard" link={Routes.DashboardOverview.path} icon={faChartPie} />
              <NavItem title="Product" link={Routes.Product.path} icon={faInbox} />
              <NavItem title="Technical" icon={faHandHoldingUsd} link={Routes.Techinical.path} />
              <NavItem title="Profile" icon={faHandHoldingUsd} link={Routes.Profile.path} />

              <NavItem title="Settings" icon={faCog} link={Routes.Settings.path} />
              <NavItem  title="Calendar" link="https://demo.themesberg.com/volt-pro-react/#/calendar" target="_blank" badgeText="Pro" icon={faCalendarAlt} />
              <NavItem  title="Map" link="https://demo.themesberg.com/volt-pro-react/#/map" target="_blank" badgeText="Pro" icon={faMapPin} />
              ...
              {/* <CollapsableNavItem eventKey="components/" title="Components" icon={faBoxOpen}>
                ...
                <NavItem title="Tooltips" link={Routes.Tooltips.path} />z
              </CollapsableNavItem> */}
            </Nav>
          </div>
        </SimpleBar>
